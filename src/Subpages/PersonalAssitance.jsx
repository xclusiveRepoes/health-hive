...
const PersonalAssitance = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#c8fcbe24] px-[10px] sm:px-[40px] pb-[50px] py-[20px] text-[#2C3E50] pt-[80px] text-[15px] sm:text-[17px]">
      ...
      <div className="pt-[30px] text-[15px] sm:text-[17px]">
        ...
        <div className="w-full flex flex-col gap-[10px] items-center justify-center py-[20px]">
          <button onClick={() => {navigate('/diet-chart')}} className="px-[20px] py-[8px] bg-green-600 text-gray-100 rounded-md cursor-pointer hover:bg-green-700 transition-colors duration-200 hover:drop-shadow-md">Get Your Personalised Diet Chart!</button>
          <button onClick={() => {navigate('/personalized-workout')}} className="px-[20px] py-[8px] bg-blue-600 text-gray-100 rounded-md cursor-pointer hover:bg-blue-700 transition-colors duration-200 hover:drop-shadow-md">Get Your Personalized Workout List!</button>
        </div>
      </div>
    </div>
  );
